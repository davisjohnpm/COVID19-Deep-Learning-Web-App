...
def uploaded_chest():
   ...
   resnet_chest = load_model('models/resnet_chest')
   vgg_chest = load_model('models/vgg_chest')
   inception_chest = load_model('models/inceptionv3_chest')
   xception_chest = load_model('models/xception_chest')
...
def uploaded_ct():
   ...
   resnet_ct = load_model('models/resnet_ct')
   vgg_ct = load_model('models/vgg_ct')
   inception_ct = load_model('models/inception_ct')
   xception_ct = load_model('models/xception_ct')
